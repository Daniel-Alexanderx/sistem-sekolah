                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-2 border rounded-lg" type="text" id="kelas"
                            placeholder="Masukkan Kelas" name="kelas" readonly>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-2 border rounded-lg" type="text" id="phone_number"
                            placeholder="Masukkan Nomor Telepon" name="phone_number" readonly>
                    </div>

                    <div class="flex justify-end col-span-2 gap-4">
                        <a href="/students" class="py-2 px-4 bg-gray-100 rounded-lg text-blue-500">Kembali</a>
                    </div>
